...
- Создание категорий товаров и их выделение в подклассы-наследники Smartphone и LawnGrass
- Управление товарами внутри категорий и вывод среднего ценника
- Автоматический подсчет количества категорий и товаров
- Перебор продуктов в рамках категории и сложение в рамках этой категории
- Загрузка данных из JSON-файла
- Вывод информации об объекте для разработчика в консоль при запуске приложения
---
...
Класс для представления товара: наследует свои свойства от абстрактного базового класса!
...
Примечание: подклассы LawnGrass и Smaprtphone имеют свои дополнительные свойства, отличные от базового класса
```
